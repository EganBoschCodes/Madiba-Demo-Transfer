...
define view entity ZSNAP_F80G_FiscalYear
	as select from ZSNAP_F80G_P_FiscalYear as main
	
	left outer to one join ZSNAP_F80G_P_FiscalYear as NextYear on main.FiscalYearVariant = NextYear.FiscalYearVariant and main.NextFiscalYearConsecutiveNmbr = NextYear.FiscalYearConsecutiveNumber
