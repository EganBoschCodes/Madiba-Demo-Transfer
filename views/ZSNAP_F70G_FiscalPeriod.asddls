...
define view entity ZSNAP_F70G_FiscalPeriod
	as select from ZSNAP_F70G_P_FiscalPeriod as main
	
	association [0..*] to ZSNAP_F70G_FiscalPeriodText as _Text on $projection.FiscalYearVariant = _Text.FiscalYearVariant and $projection.FiscalYear = _Text.FiscalYear and $projection.FiscalPeriod = _Text.FiscalPeriod
	association [0..1] to ZSNAP_F70G_FiscalYear as _FiscalYear on $projection.FiscalYearVariant = _FiscalYear.FiscalYearVariant and $projection.FiscalYear = _FiscalYear.FiscalYear
