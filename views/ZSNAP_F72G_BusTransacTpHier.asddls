...
define view entity ZSNAP_F72G_BusTransacTpHier
	as select from hrrp_directory as main
	
	association [1..*] to ZSNAP_F72G_BusTransacTpH_BZ as _Text on $projection.BusTransacTypeHier = _Text.BusTransacTypeHier and $projection.ValidityEndDate = _Text.ValidityEndDate
{
