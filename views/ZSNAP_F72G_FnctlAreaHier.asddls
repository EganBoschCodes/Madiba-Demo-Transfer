...
define view entity ZSNAP_F72G_FnctlAreaHier
	as select from hrrp_directory as main
	
	association [1..*] to ZSNAP_F72G_FnctlAreaHierT as _Text on $projection.FunctionalAreaHierarchy = _Text.FunctionalAreaHierarchy and $projection.ValidityEndDate = _Text.ValidityEndDate
{
