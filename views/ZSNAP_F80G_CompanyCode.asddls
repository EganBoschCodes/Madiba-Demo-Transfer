...
define view entity ZSNAP_F80G_CompanyCode
	as select from t001 as main
	
	left outer to one join tka02 on tka02.bukrs = main.bukrs
	
	association [0..*] to ZSNAP_F80G_CoCodeHierNode as _CompanyCodeHierNode on $projection.CompanyCode = _CompanyCodeHierNode.CompanyCode
	association [0..1] to ZSNAP_F80G_CtrllingAreaText as _ControllingAreaText on $projection.ControllingArea = _ControllingAreaText.ControllingArea
	association [0..*] to ZSNAP_F80G_CreditCtrlAreaT as _CreditControlAreaText on $projection.CreditControlArea = _CreditControlAreaText.CreditControlArea
{
