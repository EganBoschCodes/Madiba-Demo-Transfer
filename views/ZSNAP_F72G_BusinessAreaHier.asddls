...
define view entity ZSNAP_F72G_BusinessAreaHier
	as select from hrrp_directory as main
	
	association [1..*] to ZSNAP_F72G_BusAreaHierText as _Text on $projection.BusinessAreaHierarchy = _Text.BusinessAreaHierarchy and $projection.ValidityEndDate = _Text.ValidityEndDate
{
