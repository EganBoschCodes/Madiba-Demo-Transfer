...
define view entity ZSNAP_F72G_BusTransactionTp
	as select from finsc_custbttype as main
	
	association [0..*] to ZSNAP_F72G_BusTransacTpH_V4 as _BusTransacTypeHierNode on $projection.BusinessTransactionType = _BusTransacTypeHierNode.BusinessTransactionType
	association [0..*] to ZSNAP_F72G_BusTransactio_BI as _Text on $projection.BusinessTransactionType = _Text.BusinessTransactionType
{
