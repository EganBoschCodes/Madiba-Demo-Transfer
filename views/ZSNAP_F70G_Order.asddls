...
define view entity ZSNAP_F70G_Order
	as select from ZSNAP_F70G_OrderBasic as aufk
	
	left outer to one join ZSNAP_F70G_LogisticsOrde_E3 as afko on afko.OrderID = aufk.OrderID
	
	association [0..*] to ZSNAP_F70G_OrderHierNode as _OrderHierarchyNode on $projection.OrderID = _OrderHierarchyNode.OrderID
{
