...
define view entity ZSNAP_F01G_SupplierReconAcc
	as select from ZSNAP_F01G_P_ReconAccount as main
	...
	association [0..*] to ZSNAP_F01G_GLAccountText as _Text on $projection.ChartOfAccounts = _Text.ChartOfAccounts and $projection.ReconciliationAccount = _Text.GLAccount
{
