...
define view entity ZSNAP_F72G_PartnerCoHier_46
	as select from hrrp_node as main
	
	association [0..*] to ZSNAP_F72G_PartnerCoHier_19 as _Text on $projection.PartnerCompanyHierarchy = _Text.PartnerCompanyHierarchy and $projection.HierarchyNode = _Text.HierarchyNode and $projection.PartnerCompany = ''
	...
	association [1..1] to ZSNAP_F72G_PartnerCoHier as _Hierarchy on $projection.PartnerCompanyHierarchy = _Hierarchy.PartnerCompanyHierarchy and $projection.ValidityEndDate = _Hierarchy.ValidityEndDate
{
