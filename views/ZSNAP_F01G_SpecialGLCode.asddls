...
define view entity ZSNAP_F01G_SpecialGLCode
	as select from t074u as main
	
	association [1..1] to ZSNAP_F01G_FinancialAccType as _FinancialAccountType on $projection.FinancialAccountType = _FinancialAccountType.FinancialAccountType
	association [0..*] to ZSNAP_F01G_SpecialGLCdText as _Text on $projection.FinancialAccountType = _Text.FinancialAccountType and $projection.SpecialGLCode = _Text.SpecialGLCode
{
