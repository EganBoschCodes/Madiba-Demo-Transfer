...
define view entity ZSNAP_F72G_AccngDocType
	as select from t003 as main
	
	association [0..*] to ZSNAP_F72G_AccngDocTypeText as _Text on $projection.AccountingDocumentType = _Text.AccountingDocumentType
{
