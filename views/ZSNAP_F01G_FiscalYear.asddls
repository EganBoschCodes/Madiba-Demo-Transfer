...
define view entity ZSNAP_F01G_FiscalYear
	as select from ZSNAP_F01G_P_FiscalYear as main
	
	left outer to one join ZSNAP_F01G_P_FiscalYear as NextYear on main.FiscalYearVariant = NextYear.FiscalYearVariant and main.NextFiscalYearConsecutiveNmbr = NextYear.FiscalYearConsecutiveNumber
