...
define view entity ZSNAP_F01G_P_FiscYearPerTxt
	as select from ZSNAP_F01G_P_FiscPeriodText as main
	
	left outer to one join ZSNAP_F01G_FiscalPeriod as FiscPer on FiscPer.FiscalYear = main.FiscalYear and FiscPer.FiscalPeriod = main.FiscalPeriod and FiscPer.FiscalYearVariant = main.FiscalYearVariant
	left outer to one join ZSNAP_F01G_CalendarDate as CalendarYearDerive on CalendarYearDerive.CalendarDate = FiscPer.FiscalPeriodEndDate
{
	key main.Language,
