...
@EndUserText.label: 'Group Account Hierarchy Node'
...
define view entity ZSNAP_F70G_GroupAccHierNode
	...
	association [0..*] to ZSNAP_F70G_GroupAccHierN_BH as _Text on $projection.GroupAccountHierarchy = _Text.GroupAccountHierarchy and $projection.HierarchyNode = _Text.HierarchyNode and $projection.GroupAccount = ''
	association [0..1] to ZSNAP_F70G_GroupAccount as _GroupAccount on $projection.ChartOfAccounts = _GroupAccount.ChartOfAccounts and $projection.GroupAccount = _GroupAccount.GroupAccount
	association [0..1] to ZSNAP_F70G_GroupAccHier as _Hierarchy on $projection.GroupAccountHierarchy = _Hierarchy.GroupAccountHierarchy and $projection.ValidityEndDate = _Hierarchy.ValidityEndDate
{
