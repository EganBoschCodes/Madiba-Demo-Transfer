...
define view entity ZSNAP_F72G_DebitCreditCode
	as select from dd07l as main
	
	association [0..*] to ZSNAP_F72G_DebitCreditCdTxt as _Text on $projection.DebitCreditCode = _Text.DebitCreditCode
{
