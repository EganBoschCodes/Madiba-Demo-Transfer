...
define view entity ZSNAP_F72G_OrderHierarchy
	as select from hrrp_directory as main
	
	association [1..*] to ZSNAP_F72G_OrderHierText as _Text on $projection.OrderHierarchy = _Text.OrderHierarchy and $projection.ValidityEndDate = _Text.ValidityEndDate
{
