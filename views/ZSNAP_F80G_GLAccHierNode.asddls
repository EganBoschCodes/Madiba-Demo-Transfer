...
define view entity ZSNAP_F80G_GLAccHierNode
	...
	association [0..*] to ZSNAP_F80G_GLAccHierNodeT as _Text on $projection.GLAccountHierarchy = _Text.GLAccountHierarchy and $projection.HierarchyNode = _Text.HierarchyNode and $projection.GLAccount = ''
	...
	association [0..1] to ZSNAP_F80G_GLAccHierarchy as _Hierarchy on $projection.GLAccountHierarchy = _Hierarchy.GLAccountHierarchy and $projection.ValidityEndDate = _Hierarchy.ValidityEndDate
{
