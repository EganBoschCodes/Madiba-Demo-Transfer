...
define view entity ZSNAP_F70G_CostCenter
	...
	association [0..*] to ZSNAP_F70G_CCHierNode as _CostCenterHierarchyNode on $projection.ControllingArea = _CostCenterHierarchyNode.ControllingArea and $projection.CostCenter = _CostCenterHierarchyNode.CostCenter
	association [0..1] to ZSNAP_F70G_CostCenterText as _Text on $projection.ControllingArea = _Text.ControllingArea and $projection.CostCenter = _Text.CostCenter
{
