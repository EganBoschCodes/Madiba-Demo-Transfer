...
define view entity ZSNAP_F70G_BusAreaHierNode
	as select from hrrp_node as main
	
	inner join ZSNAP_F70G_BusinessAreaHier as HierarchyDirectory on HierarchyDirectory.BusinessAreaHierarchy = main.hryid and HierarchyDirectory.ValidityEndDate = main.hryvalto
	
	association [0..*] to ZSNAP_F70G_BusAreaHierNodeT as _Text on $projection.BusinessAreaHierarchy = _Text.BusinessAreaHierarchy and $projection.HierarchyNode = _Text.HierarchyNode and $projection.BusinessArea = ''
	association [0..1] to ZSNAP_F70G_BusinessArea as _BusinessArea on $projection.BusinessArea = _BusinessArea.BusinessArea
	association [1..1] to ZSNAP_F70G_BusinessAreaHier as _Hierarchy on $projection.BusinessAreaHierarchy = _Hierarchy.BusinessAreaHierarchy and $projection.ValidityEndDate = _Hierarchy.ValidityEndDate
{
