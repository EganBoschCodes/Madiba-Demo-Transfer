...
define view entity ZSNAP_F01G_FiscalYearPeriod
	as select from ZSNAP_F01G_P_FiscalPeriod as main
	
	association [0..1] to ZSNAP_F01G_FiscCalendarDate as _FiscalCalendarDate on $projection.FiscalYearVariant = _FiscalCalendarDate.FiscalYearVariant and $projection.FiscalPeriodEndDate = _FiscalCalendarDate.CalendarDate
	association [0..*] to ZSNAP_F01G_FiscYearPerTxt as _Text on $projection.FiscalYearVariant = _Text.FiscalYearVariant and $projection.FiscalYearPeriod = _Text.FiscalYearPeriod
