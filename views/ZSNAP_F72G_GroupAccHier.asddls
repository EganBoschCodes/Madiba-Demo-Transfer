...
define view entity ZSNAP_F72G_GroupAccHier
	...
	association [0..*] to ZSNAP_F72G_GroupAccHierText as _Text on $projection.GroupAccountHierarchy = _Text.GroupAccountHierarchy and $projection.ValidityEndDate = _Text.ValidityEndDate
{
