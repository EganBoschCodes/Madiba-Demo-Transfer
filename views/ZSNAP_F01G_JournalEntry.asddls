...
define view entity ZSNAP_F01G_JournalEntry
	as select from ZSNAP_F01G_P_BKPF_COM as main
	
	association [0..*] to ZSNAP_F01G_AccngDocTypeText as _AccountingDocumentTypeText on $projection.AccountingDocumentType = _AccountingDocumentTypeText.AccountingDocumentType
	association [0..*] to ZSNAP_F01G_BusTransactio_ET as _BusinessTransactionTypeText on $projection.BusinessTransactionType = _BusinessTransactionTypeText.BusinessTransactionType
	...
	association [0..*] to ZSNAP_F01G_LedgerText as _LedgerText on $projection.Ledger = _LedgerText.Ledger
{
