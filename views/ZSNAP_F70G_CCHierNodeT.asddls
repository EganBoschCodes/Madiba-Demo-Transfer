...
define view entity ZSNAP_F70G_CCHierNodeT
	...
	association [1..*] to ZSNAP_F70G_CostCenterHier as _Hierarchy on $projection.CostCenterHierarchy = _Hierarchy.CostCenterHierarchy and $projection.ControllingArea = _Hierarchy.ControllingArea
{
