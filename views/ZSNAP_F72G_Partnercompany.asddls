...
define view entity ZSNAP_F72G_Partnercompany
	as select from ZSNAP_F72G_GlobalCompany as PartnerCompany
	
	association [0..*] to ZSNAP_F72G_PartnerCoHier_46 as _PartnerCompanyHierNode on $projection.PartnerCompany = _PartnerCompanyHierNode.PartnerCompany
{
