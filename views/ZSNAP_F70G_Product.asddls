...
define view entity ZSNAP_F70G_Product
	as select from mara as main
	
	association [0..*] to ZSNAP_F70G_ProdUnivHierNode as _ProdUnivHierarchyNode on $projection.Product = _ProdUnivHierarchyNode.Product
	association [0..*] to ZSNAP_F70G_ProductText as _Text on $projection.Product = _Text.Product
{
