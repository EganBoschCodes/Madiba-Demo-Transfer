...
define view entity ZSNAP_F01G_PostingKey
	as select from tbsl as main
	
	association [0..*] to ZSNAP_F01G_PostingKeyText as _PostingKeyText on $projection.PostingKey = _PostingKeyText.PostingKey
{
