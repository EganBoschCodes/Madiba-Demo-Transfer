...
define view entity ZSNAP_F01G_AccngDocCategory
	as select from dd07l as main
	
	association [0..*] to ZSNAP_F01G_AccngDocCateg_LZ as _Text on $projection.AccountingDocumentCategory = _Text.AccountingDocumentCategory
{
