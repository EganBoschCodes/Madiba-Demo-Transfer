...
define view entity ZSNAP_F01G_OplAcctgDocItem
	as select from ZSNAP_F01G_P_BSEG_COM as main
	
	association [1..1] to ZSNAP_F01G_CompanyCode as _CompanyCode on $projection.CompanyCode = _CompanyCode.CompanyCode
	...
	association [0..1] to ZSNAP_F01G_JournalEntry as _JournalEntry on $projection.CompanyCode = _JournalEntry.CompanyCode and $projection.FiscalYear = _JournalEntry.FiscalYear and $projection.AccountingDocument = _JournalEntry.AccountingDocument and $projection.FiscalYearVariant = _JournalEntry.FiscalYearVariant
{
