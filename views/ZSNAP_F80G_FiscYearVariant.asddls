...
define view entity ZSNAP_F80G_FiscYearVariant
	as select from t009 as main
	
	association [0..*] to ZSNAP_F80G_FiscYearVrntTxt as _Text on $projection.FiscalYearVariant = _Text.FiscalYearVariant
{
