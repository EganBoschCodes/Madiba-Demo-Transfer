...
define view entity ZSNAP_F72G_Housebank
	...
	association [1..1] to ZSNAP_F72G_DfltBusPartner as _DefaultableBP on $projection.BankCountry = _DefaultableBP.BankCountry and $projection.BankInternalID = _DefaultableBP.BankInternalID and _DefaultableBP.ValidTo >= $session.system_date and _DefaultableBP.ValidFrom <= $session.system_date
	association [1..1] to ZSNAP_F72G_RiskBusPartner as _RiskBP on $projection.BankCountry = _RiskBP.BankCountry and $projection.BankInternalID = _RiskBP.BankInternalID and _RiskBP.ValidTo >= $session.system_date and _RiskBP.ValidFrom <= $session.system_date
{
