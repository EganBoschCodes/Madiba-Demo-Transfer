...
define view entity ZSNAP_F01G_FiscalPeriod
	as select from ZSNAP_F01G_P_FiscalPeriod as main
	
	association [0..*] to ZSNAP_F01G_FiscalPeriodText as _Text on $projection.FiscalYearVariant = _Text.FiscalYearVariant and $projection.FiscalYear = _Text.FiscalYear and $projection.FiscalPeriod = _Text.FiscalPeriod
