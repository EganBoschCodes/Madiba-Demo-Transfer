...
define view entity ZSNAP_F80G_GlobalCompany
	as select from t880 as main
	
	association [0..*] to ZSNAP_F80G_GlobalCoHierNode as _GlobalCompanyHierNode on $projection.Company = _GlobalCompanyHierNode.Company
{
