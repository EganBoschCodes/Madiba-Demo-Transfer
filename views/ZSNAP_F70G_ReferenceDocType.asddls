...
define view entity ZSNAP_F70G_ReferenceDocType
	as select from ttyp as main
	
	association [0..*] to ZSNAP_F70G_ReferenceDocTpT as _Text on $projection.ReferenceDocumentType = _Text.ReferenceDocumentType
{
