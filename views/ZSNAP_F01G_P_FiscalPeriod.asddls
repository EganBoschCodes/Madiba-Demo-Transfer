...
define view entity ZSNAP_F01G_P_FiscalPeriod
	as select from finsc_period as main
	
	left outer to one join ZSNAP_F01G_P_FiscCalDate as fisc_cal_date on main.fiscal_year_variant = fisc_cal_date.fiscal_year_variant and main.fiscal_period_end_date = fisc_cal_date.calendar_date
{
