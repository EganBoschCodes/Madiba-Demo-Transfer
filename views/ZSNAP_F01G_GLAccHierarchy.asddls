...
define view entity ZSNAP_F01G_GLAccHierarchy
	...
	association [0..*] to ZSNAP_F01G_GLAccHierText as _Text on $projection.GLAccountHierarchy = _Text.GLAccountHierarchy and $projection.ValidityEndDate = _Text.ValidityEndDate
{
