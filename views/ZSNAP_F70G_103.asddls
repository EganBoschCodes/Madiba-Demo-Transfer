...
define view entity ZSNAP_F70G_103
	as select from ZSNAP_F70G_PCHierNode as main
	
	association [0..*] to ZSNAP_F70G_102 as _Text on $projection.HierarchyNode = _Text.HierarchyNode
{
