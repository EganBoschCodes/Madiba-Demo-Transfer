...
define view entity ZSNAP_F72G_ProdUnivHierB_BJ
	as select from hrrp_directory as main
	
	association [0..*] to ZSNAP_F72G_ProdUnivHierT_2 as _Text on $projection.ProdUnivHierarchy = _Text.ProdUnivHierarchy
{
