...
define view entity ZSNAP_F01G_CompanyCodeHier
	as select from hrrp_directory as main
	
	association [1..*] to ZSNAP_F01G_CompanyCodeHierT as _Text on $projection.CompanyCodeHierarchy = _Text.CompanyCodeHierarchy and $projection.ValidityEndDate = _Text.ValidityEndDate
{
