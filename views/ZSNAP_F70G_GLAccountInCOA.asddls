...
define view entity ZSNAP_F70G_GLAccountInCOA
	...
	association [0..*] to ZSNAP_F70G_GLAccHierNode as _GLAccountHierarchyNode on $projection.GLAccount = _GLAccountHierarchyNode.GLAccount and $projection.ChartOfAccounts = _GLAccountHierarchyNode.ChartOfAccounts
	association [0..*] to ZSNAP_F70G_GLAccountText as _Text on $projection.ChartOfAccounts = _Text.ChartOfAccounts and $projection.GLAccount = _Text.GLAccount
{
