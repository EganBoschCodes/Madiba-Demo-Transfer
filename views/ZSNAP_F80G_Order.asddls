...
define view entity ZSNAP_F80G_Order
	as select from ZSNAP_F80G_OrderBasic as aufk
	
	left outer to one join ZSNAP_F80G_LogisticsOrde_BU as afko on afko.OrderID = aufk.OrderID
	
	association [0..*] to ZSNAP_F80G_OrderHierNode as _OrderHierarchyNode on $projection.OrderID = _OrderHierarchyNode.OrderID
{
