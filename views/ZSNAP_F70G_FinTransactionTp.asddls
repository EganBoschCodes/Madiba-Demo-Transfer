...
define view entity ZSNAP_F70G_FinTransactionTp
	as select from t856 as main
	
	association [0..*] to ZSNAP_F70G_FinTransactio_RT as _Text on $projection.FinancialTransactionType = _Text.FinancialTransactionType
{
