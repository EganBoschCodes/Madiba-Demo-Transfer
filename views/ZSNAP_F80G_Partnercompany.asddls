...
define view entity ZSNAP_F80G_Partnercompany
	as select from ZSNAP_F80G_GlobalCompany as PartnerCompany
	
	association [0..*] to ZSNAP_F80G_PartnerCoHier_QM as _PartnerCompanyHierNode on $projection.PartnerCompany = _PartnerCompanyHierNode.PartnerCompany
{
