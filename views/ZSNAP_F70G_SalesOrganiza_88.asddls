...
define view entity ZSNAP_F70G_SalesOrganiza_88
	as select from tvko as main
	
	association [0..*] to ZSNAP_F70G_SalesOrganiza_UO as _Text on $projection.SalesOrganization = _Text.SalesOrganization
{
