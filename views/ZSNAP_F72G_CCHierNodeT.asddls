...
define view entity ZSNAP_F72G_CCHierNodeT
	...
	association [1..*] to ZSNAP_F72G_CostCenterHier as _Hierarchy on $projection.CostCenterHierarchy = _Hierarchy.CostCenterHierarchy and $projection.ControllingArea = _Hierarchy.ControllingArea
{
