...
define view entity ZSNAP_F80G_CostCenter
	...
	association [0..*] to ZSNAP_F80G_CCHierNode as _CostCenterHierarchyNode on $projection.ControllingArea = _CostCenterHierarchyNode.ControllingArea and $projection.CostCenter = _CostCenterHierarchyNode.CostCenter
	association [0..1] to ZSNAP_F80G_CostCenterText as _Text on $projection.ControllingArea = _Text.ControllingArea and $projection.CostCenter = _Text.CostCenter
{
