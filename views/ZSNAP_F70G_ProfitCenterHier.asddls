...
define view entity ZSNAP_F70G_ProfitCenterHier
	...
	association [*] to ZSNAP_F70G_PCHierText as _Text on $projection.ProfitCenterHierarchy = _Text.ProfitCenterHierarchy and $projection.ControllingArea = _Text.ControllingArea
{
