...
define view entity ZSNAP_F70G_GroupAccHier
	...
	association [0..*] to ZSNAP_F70G_GroupAccHierText as _Text on $projection.GroupAccountHierarchy = _Text.GroupAccountHierarchy and $projection.ValidityEndDate = _Text.ValidityEndDate
{
