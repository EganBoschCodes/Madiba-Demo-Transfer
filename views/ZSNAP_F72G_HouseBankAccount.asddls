...
define view entity ZSNAP_F72G_HouseBankAccount
	as select from ZSNAP_F72G_P_HouseBankAcc as main
	
	association [0..1] to ZSNAP_F72G_CompanyCode as _CompanyCode on $projection.CompanyCode = _CompanyCode.CompanyCode
	association [1..*] to ZSNAP_F72G_HouseBankAccText as _Text on $projection.CompanyCode = _Text.CompanyCode and $projection.HouseBank = _Text.HouseBank and $projection.HouseBankAccount = _Text.HouseBankAccount
	association [0..1] to ZSNAP_F72G_Housebank as _HouseBank on $projection.HouseBank = _HouseBank.HouseBank and $projection.CompanyCode = _HouseBank.CompanyCode
{
