...
define view entity ZSNAP_F70G_FnctlAreaHier_HN
	as select from hrrp_node as main
	
	inner join ZSNAP_F70G_FnctlAreaHier as HierarchyDirectory on HierarchyDirectory.FunctionalAreaHierarchy = main.hryid and HierarchyDirectory.ValidityEndDate = main.hryvalto
	
	association [0..*] to ZSNAP_F70G_FnctlAreaHier_B7 as _Text on $projection.FunctionalAreaHierarchy = _Text.FunctionalAreaHierarchy and $projection.HierarchyNode = _Text.HierarchyNode and $projection.FunctionalArea = ''
	...
	association [1..1] to ZSNAP_F70G_FnctlAreaHier as _Hierarchy on $projection.FunctionalAreaHierarchy = _Hierarchy.FunctionalAreaHierarchy and $projection.ValidityEndDate = _Hierarchy.ValidityEndDate
{
