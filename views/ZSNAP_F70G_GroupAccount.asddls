...
define view entity ZSNAP_F70G_GroupAccount
	...
	association [0..*] to ZSNAP_F70G_GLAccountText as _Text on $projection.ChartOfAccounts = _Text.ChartOfAccounts and $projection.GroupAccount = _Text.GLAccount
	association [0..*] to ZSNAP_F70G_GroupAccHierNode as _GroupAccHierarchyNode on $projection.GroupAccount = _GroupAccHierarchyNode.GroupAccount and $projection.ChartOfAccounts = _GroupAccHierarchyNode.ChartOfAccounts
{
