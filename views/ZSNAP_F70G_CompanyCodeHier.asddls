...
define view entity ZSNAP_F70G_CompanyCodeHier
	as select from hrrp_directory as main
	
	association [1..*] to ZSNAP_F70G_CompanyCodeHierT as _Text on $projection.CompanyCodeHierarchy = _Text.CompanyCodeHierarchy and $projection.ValidityEndDate = _Text.ValidityEndDate
{
