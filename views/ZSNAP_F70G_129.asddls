...
define view entity ZSNAP_F70G_129
	as select from ZSNAP_F70G_GLAccHierNode as LeafNode
	
	left outer to one join ZSNAP_F70G_GLAccHierNode as Parent1 on LeafNode.ParentNode = Parent1.HierarchyNode and LeafNode.GLAccountHierarchy = Parent1.GLAccountHierarchy and Parent1.ValidityEndDate = '99991231'
	left outer to one join ZSNAP_F70G_GLAccHierNode as Parent2 on Parent1.ParentNode = Parent2.HierarchyNode and LeafNode.GLAccountHierarchy = Parent2.GLAccountHierarchy and Parent2.ValidityEndDate = '99991231'
	left outer to one join ZSNAP_F70G_GLAccHierNode as Parent3 on Parent2.ParentNode = Parent3.HierarchyNode and LeafNode.GLAccountHierarchy = Parent3.GLAccountHierarchy and Parent3.ValidityEndDate = '99991231'
	left outer to one join ZSNAP_F70G_GLAccHierNode as Parent4 on Parent3.ParentNode = Parent4.HierarchyNode and LeafNode.GLAccountHierarchy = Parent4.GLAccountHierarchy and Parent4.ValidityEndDate = '99991231'
	left outer to one join ZSNAP_F70G_GLAccHierNode as Parent5 on Parent4.ParentNode = Parent5.HierarchyNode and LeafNode.GLAccountHierarchy = Parent5.GLAccountHierarchy and Parent5.ValidityEndDate = '99991231'
	left outer to one join ZSNAP_F70G_GLAccHierNode as Parent6 on Parent5.ParentNode = Parent6.HierarchyNode and LeafNode.GLAccountHierarchy = Parent6.GLAccountHierarchy and Parent6.ValidityEndDate = '99991231'
	left outer to one join ZSNAP_F70G_GLAccHierNode as Parent7 on Parent6.ParentNode = Parent7.HierarchyNode and LeafNode.GLAccountHierarchy = Parent7.GLAccountHierarchy and Parent7.ValidityEndDate = '99991231'
	left outer to one join ZSNAP_F70G_GLAccHierNode as Parent8 on Parent7.ParentNode = Parent8.HierarchyNode and LeafNode.GLAccountHierarchy = Parent8.GLAccountHierarchy and Parent8.ValidityEndDate = '99991231'
	left outer to one join ZSNAP_F70G_GLAccHierNode as Parent9 on Parent8.ParentNode = Parent9.HierarchyNode and LeafNode.GLAccountHierarchy = Parent9.GLAccountHierarchy and Parent9.ValidityEndDate = '99991231'
	left outer to one join ZSNAP_F70G_GLAccHierNode as Parent10 on Parent9.ParentNode = Parent10.HierarchyNode and LeafNode.GLAccountHierarchy = Parent10.GLAccountHierarchy and Parent10.ValidityEndDate = '99991231'
	left outer to one join ZSNAP_F70G_GLAccHierNode as Parent11 on Parent10.ParentNode = Parent11.HierarchyNode and LeafNode.GLAccountHierarchy = Parent11.GLAccountHierarchy and Parent11.ValidityEndDate = '99991231'
	left outer to one join ZSNAP_F70G_GLAccHierNode as Parent12 on Parent11.ParentNode = Parent12.HierarchyNode and LeafNode.GLAccountHierarchy = Parent12.GLAccountHierarchy and Parent12.ValidityEndDate = '99991231'
	left outer to one join ZSNAP_F70G_GLAccHierNode as Parent13 on Parent12.ParentNode = Parent13.HierarchyNode and LeafNode.GLAccountHierarchy = Parent13.GLAccountHierarchy and Parent13.ValidityEndDate = '99991231'
	left outer to one join ZSNAP_F70G_GLAccHierNode as Parent14 on Parent13.ParentNode = Parent14.HierarchyNode and LeafNode.GLAccountHierarchy = Parent14.GLAccountHierarchy and Parent14.ValidityEndDate = '99991231'
{
