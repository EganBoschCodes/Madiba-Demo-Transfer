...
define view entity ZSNAP_F72G_ControllingArea
	as select from tka01 as main
	
	cross join ZSNAP_F72G_SAPClient as SAPClient
	
	association [0..*] to ZSNAP_F72G_FinStmntHierT as _FinancialStatementVersionText on $projection.CtrlgStdFinStatementVersion = _FinancialStatementVersionText.FinancialStatementHierarchy
{
