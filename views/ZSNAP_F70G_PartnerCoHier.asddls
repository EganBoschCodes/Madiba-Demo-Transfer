...
define view entity ZSNAP_F70G_PartnerCoHier
	as select from hrrp_directory as main
	
	association [1..*] to ZSNAP_F70G_PartnerCoHierT as _Text on $projection.PartnerCompanyHierarchy = _Text.PartnerCompanyHierarchy and $projection.ValidityEndDate = _Text.ValidityEndDate
{
