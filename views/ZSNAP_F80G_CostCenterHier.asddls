...
define view entity ZSNAP_F80G_CostCenterHier
	...
	association [1..*] to ZSNAP_F80G_CCHierText as _Text on $projection.CostCenterHierarchy = _Text.CostCenterHierarchy and $projection.ControllingArea = _Text.ControllingArea
{
