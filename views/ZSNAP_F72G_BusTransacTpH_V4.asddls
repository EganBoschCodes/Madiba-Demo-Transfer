...
define view entity ZSNAP_F72G_BusTransacTpH_V4
	as select from hrrp_node as main
	
	association [0..*] to ZSNAP_F72G_BusTransacTpH_OS as _Text on $projection.BusTransacTypeHier = _Text.BusTransacTypeHier and $projection.HierarchyNode = _Text.HierarchyNode and $projection.BusinessTransactionType = ''
	...
	association [1..1] to ZSNAP_F72G_BusTransacTpHier as _Hierarchy on $projection.BusTransacTypeHier = _Hierarchy.BusTransacTypeHier and $projection.ValidityEndDate = _Hierarchy.ValidityEndDate
{
