...
define view entity ZSNAP_F72G_GLAccLineItem
	as select from acdoca as main
{
	...
	cast (main.sbusa as fis_pargb preserving type) as PartnerBusinessArea,
	...
	cast (main.ebelp as fis_ebelp preserving type) as PurchasingDocumentItem,
	...
	cast (main.matnr as productnumber) as Material,
	main.werks as Plant,
	...
	cast (main.auggj as fis_auggj_no_conv preserving type) as ClearingDocFiscalYear,
	cast (main.augbl as fis_augbl preserving type) as ClearingAccountingDocument,
	...
	main.matnr_copa as SoldMaterial,
