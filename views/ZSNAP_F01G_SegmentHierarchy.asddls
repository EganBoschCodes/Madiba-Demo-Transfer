...
define view entity ZSNAP_F01G_SegmentHierarchy
	as select from hrrp_directory as main
	
	association [1..*] to ZSNAP_F01G_SegmentHierText as _Text on $projection.SegmentHierarchy = _Text.SegmentHierarchy and $projection.ValidityEndDate = _Text.ValidityEndDate
{
