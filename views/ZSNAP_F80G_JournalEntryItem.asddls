...
define view entity ZSNAP_F80G_JournalEntryItem
	as select from acdoca as main
{
	...
	cast (main.ps_psp_pnr as fis_wbsint_no_conv preserving type) as WBSElementInternalID,
	cast (main.ps_prj_pnr as fis_projectint_no_conv preserving type) as ProjectInternalID,
	main.matkl as SoldProductGroup,
