...
define view entity ZSNAP_F70G_FinancialAccType
	as select from dd07l as main
	
	association [0..*] to ZSNAP_F70G_FinAccTpTxt as _Text on $projection.FinancialAccountType = _Text.FinancialAccountType
{
