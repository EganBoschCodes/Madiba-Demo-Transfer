...
@ObjectModel.representativeKey: 'GroupAccount'
@ObjectModel.usageType.dataClass: #MASTER
@ObjectModel.usageType.serviceQuality: #B
@ObjectModel.usageType.sizeCategory: #M

define view entity ZSNAP_F72G_GroupAccount
	...
	association [0..*] to ZSNAP_F72G_GLAccGroupText as _GLAccountGroupText on $projection.GLAccountGroup = _GLAccountGroupText.GLAccountGroup and $projection.ChartOfAccounts = _GLAccountGroupText.ChartOfAccounts
	association [0..*] to ZSNAP_F72G_GLAccountText as _Text on $projection.ChartOfAccounts = _Text.ChartOfAccounts and $projection.GroupAccount = _Text.GLAccount
	association [0..*] to ZSNAP_F72G_GroupAccHierNode as _GroupAccHierarchyNode on $projection.GroupAccount = _GroupAccHierarchyNode.GroupAccount and $projection.ChartOfAccounts = _GroupAccHierarchyNode.ChartOfAccounts
{
