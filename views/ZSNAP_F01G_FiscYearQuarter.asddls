...
define view entity ZSNAP_F01G_FiscYearQuarter
	as select from ZSNAP_F01G_P_FiscalQuarter as main
	
	left outer to one join ZSNAP_F01G_P_FiscalQuarter as NextQuarter on main.FiscalYearVariant = NextQuarter.FiscalYearVariant and main.NextFsclQuarterConsecutiveNmbr = NextQuarter.FiscalQuarterConsecutiveNumber
