...
define view entity ZSNAP_F72G_OrderHierNode
	as select from hrrp_node as main
	
	association [0..*] to ZSNAP_F72G_OrderHierNodeTxt as _Text on $projection.OrderHierarchy = _Text.OrderHierarchy and $projection.HierarchyNode = _Text.HierarchyNode and $projection.OrderID = ''
	association [0..1] to ZSNAP_F72G_Order as _Order on $projection.OrderID = _Order.OrderID
	association [1..1] to ZSNAP_F72G_OrderHierarchy as _Hierarchy on $projection.OrderHierarchy = _Hierarchy.OrderHierarchy and $projection.ValidityEndDate = _Hierarchy.ValidityEndDate
{
