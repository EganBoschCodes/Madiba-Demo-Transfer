...
define view entity ZSNAP_F70G_ProfitCenter
	...
	association [0..*] to ZSNAP_F70G_PCHierNode as _ProfitCenterHierarchyNode on $projection.ControllingArea = _ProfitCenterHierarchyNode.ControllingArea and $projection.ProfitCenter = _ProfitCenterHierarchyNode.ProfitCenter
	association [0..*] to ZSNAP_F70G_ProfitCenterText as _Text on $projection.ControllingArea = _Text.ControllingArea and $projection.ProfitCenter = _Text.ProfitCenter
{
