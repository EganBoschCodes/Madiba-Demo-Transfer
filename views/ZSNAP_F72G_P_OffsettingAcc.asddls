...
define view entity ZSNAP_F72G_P_OffsettingAcc
	as select from ZSNAP_F72G_GLAccountInCOA as main
{
...
union all select from ZSNAP_F72G_GLAccountInCOA as main
{
	key main.ChartOfAccounts,
	key cast (main.GLAccount as fis_gkont) as OffsettingAccount,
...
union all select from ZSNAP_F72G_Customer as main
{
...
union all select from ZSNAP_F72G_Supplier as main
{
	key cast (cast ('' as abap.char (4)) as fis_ktopl) as ChartOfAccounts,
