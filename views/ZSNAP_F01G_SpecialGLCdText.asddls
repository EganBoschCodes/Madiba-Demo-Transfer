...
define view entity ZSNAP_F01G_SpecialGLCdText
	as select from t074t as main
	
	association [0..1] to ZSNAP_F01G_FinancialAccType as _FinancialAccountType on $projection.FinancialAccountType = _FinancialAccountType.FinancialAccountType
{
