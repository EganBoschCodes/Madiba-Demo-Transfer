...
define view entity ZSNAP_F70G_ProdUnivHierNode
	as select from ZSNAP_F70G_ProdUnivHierN_TU as node
	
	association [1..1] to ZSNAP_F70G_ProdUnivHierB_BH as _ProductHierarchy on $projection.ProductHierarchy = _ProductHierarchy.ProdUnivHierarchy and $projection.ProdHierarchyValidityEndDate = _ProductHierarchy.ProdHierarchyValidityEndDate
	association [0..*] to ZSNAP_F70G_ProdUnivHierN_BF as _Text on $projection.ProductHierarchy = _Text.ProdUnivHierarchy and $projection.ProductHierarchyNode = _Text.HierarchyNode and $projection.Product = ''
	association [1..1] to ZSNAP_F70G_Product as _Product on $projection.Product = _Product.Product
{
