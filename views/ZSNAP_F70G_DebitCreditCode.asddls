...
define view entity ZSNAP_F70G_DebitCreditCode
	as select from dd07l as main
	
	association [0..*] to ZSNAP_F70G_DebitCreditCdTxt as _Text on $projection.DebitCreditCode = _Text.DebitCreditCode
{
