...
define view entity ZSNAP_F72G_109
	as select from ZSNAP_F72G_108 as LeafNode
	
	left outer to one join ZSNAP_F72G_108 as Parent1 on LeafNode.ParentNode = Parent1.HierarchyNode and LeafNode.ProfitCenterHierarchy = Parent1.ProfitCenterHierarchy
	left outer to one join ZSNAP_F72G_108 as Parent2 on Parent1.ParentNode = Parent2.HierarchyNode and Parent1.ProfitCenterHierarchy = Parent2.ProfitCenterHierarchy
	left outer to one join ZSNAP_F72G_108 as Parent3 on Parent2.ParentNode = Parent3.HierarchyNode and Parent2.ProfitCenterHierarchy = Parent3.ProfitCenterHierarchy
	left outer to one join ZSNAP_F72G_108 as Parent4 on Parent3.ParentNode = Parent4.HierarchyNode and Parent3.ProfitCenterHierarchy = Parent4.ProfitCenterHierarchy
	left outer to one join ZSNAP_F72G_108 as Parent5 on Parent4.ParentNode = Parent5.HierarchyNode and Parent4.ProfitCenterHierarchy = Parent5.ProfitCenterHierarchy
	left outer to one join ZSNAP_F72G_108 as Parent6 on Parent5.ParentNode = Parent6.HierarchyNode and Parent5.ProfitCenterHierarchy = Parent6.ProfitCenterHierarchy
	left outer to one join ZSNAP_F72G_108 as Parent7 on Parent6.ParentNode = Parent7.HierarchyNode and Parent6.ProfitCenterHierarchy = Parent7.ProfitCenterHierarchy
	left outer to one join ZSNAP_F72G_108 as Parent8 on Parent7.ParentNode = Parent8.HierarchyNode and Parent7.ProfitCenterHierarchy = Parent8.ProfitCenterHierarchy
	left outer to one join ZSNAP_F72G_108 as Parent9 on Parent8.ParentNode = Parent9.HierarchyNode and Parent8.ProfitCenterHierarchy = Parent9.ProfitCenterHierarchy
	left outer to one join ZSNAP_F72G_108 as Parent10 on Parent9.ParentNode = Parent10.HierarchyNode and Parent9.ProfitCenterHierarchy = Parent10.ProfitCenterHierarchy
	left outer to one join ZSNAP_F72G_108 as Parent11 on Parent10.ParentNode = Parent11.HierarchyNode and Parent10.ProfitCenterHierarchy = Parent11.ProfitCenterHierarchy
	left outer to one join ZSNAP_F72G_108 as Parent12 on Parent11.ParentNode = Parent12.HierarchyNode and Parent11.ProfitCenterHierarchy = Parent12.ProfitCenterHierarchy
{
