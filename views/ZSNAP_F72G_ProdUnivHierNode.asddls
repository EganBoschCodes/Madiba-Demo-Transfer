...
define view entity ZSNAP_F72G_ProdUnivHierNode
	as select from ZSNAP_F72G_ProdUnivHierN_3C as node
	
	association [1..1] to ZSNAP_F72G_ProdUnivHierB_BJ as _ProductHierarchy on $projection.ProductHierarchy = _ProductHierarchy.ProdUnivHierarchy and $projection.ProdHierarchyValidityEndDate = _ProductHierarchy.ProdHierarchyValidityEndDate
	association [0..*] to ZSNAP_F72G_ProdUnivHierN_B1 as _Text on $projection.ProductHierarchy = _Text.ProdUnivHierarchy and $projection.ProductHierarchyNode = _Text.HierarchyNode and $projection.Product = ''
	association [1..1] to ZSNAP_F72G_Product as _Product on $projection.Product = _Product.Product
{
