...
define view entity ZSNAP_F72G_Product
	as select from mara as main
	
	association [0..*] to ZSNAP_F72G_ProdUnivHierNode as _ProdUnivHierarchyNode on $projection.Product = _ProdUnivHierarchyNode.Product
	association [0..*] to ZSNAP_F72G_ProductText as _Text on $projection.Product = _Text.Product
{
