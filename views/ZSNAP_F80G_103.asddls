...
define view entity ZSNAP_F80G_103
	as select from ZSNAP_F80G_PCHierNode as main
	
	association [0..*] to ZSNAP_F80G_102 as _Text on $projection.HierarchyNode = _Text.HierarchyNode
{
