...
define view entity ZSNAP_F70G_CostCenterHier
	...
	association [1..*] to ZSNAP_F70G_CCHierText as _Text on $projection.CostCenterHierarchy = _Text.CostCenterHierarchy and $projection.ControllingArea = _Text.ControllingArea
{
