...
define view entity ZSNAP_F80G_ProdUnivHierB_BN
	as select from hrrp_directory as main
	
	association [0..*] to ZSNAP_F80G_ProdUnivHierT_2 as _Text on $projection.ProdUnivHierarchy = _Text.ProdUnivHierarchy
{
