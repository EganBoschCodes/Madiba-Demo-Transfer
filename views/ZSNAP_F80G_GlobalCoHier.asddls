...
define view entity ZSNAP_F80G_GlobalCoHier
	as select from hrrp_directory as main
	
	association [1..*] to ZSNAP_F80G_GlobalCoHierT as _Text on $projection.GlobalCompanyHierarchy = _Text.GlobalCompanyHierarchy and $projection.ValidityEndDate = _Text.ValidityEndDate
{
