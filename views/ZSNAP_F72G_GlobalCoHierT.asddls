...
define view entity ZSNAP_F72G_GlobalCoHierT
...
{
	key cast (hrrp_directory.hryid as fis_hryid_company) as GlobalCompanyHierarchy,
	...
	@Semantics.text
	main.hrytxt as GlobalCompanyHierarchyName
}
