...
define view entity ZSNAP_F72G_122
	as select from ZSNAP_F72G_GLAccHierNode as main
	
	association [0..*] to ZSNAP_F72G_121 as _Text on $projection.HierarchyNode = _Text.HierarchyNode and $projection.GLAccountHierarchy = _Text.GLAccountHierarchy
	association [0..1] to ZSNAP_F72G_GLAccHierarchy as _Hierarchy on $projection.GLAccountHierarchy = _Hierarchy.GLAccountHierarchy
{
