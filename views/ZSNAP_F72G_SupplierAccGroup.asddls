...
define view entity ZSNAP_F72G_SupplierAccGroup
	as select from t077k as main
	
	association [0..*] to ZSNAP_F72G_SuppAccGroupText as _SupplierAccountGroupText on $projection.SupplierAccountGroup = _SupplierAccountGroupText.SupplierAccountGroup
{
