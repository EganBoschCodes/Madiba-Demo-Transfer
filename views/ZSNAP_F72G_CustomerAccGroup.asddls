...
define view entity ZSNAP_F72G_CustomerAccGroup
	as select from t077d as main
	
	association [0..*] to ZSNAP_F72G_CustAccGroupText as _CustomerAccountGroupText on $projection.CustomerAccountGroup = _CustomerAccountGroupText.CustomerAccountGroup
{
