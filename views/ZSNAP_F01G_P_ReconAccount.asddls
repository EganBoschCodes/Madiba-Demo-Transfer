...
define view entity ZSNAP_F01G_P_ReconAccount
	as select from ZSNAP_F01G_P_ReconAccBasis as main
	
	association [0..1] to ZSNAP_F01G_GLAccountInCOA as _Data on $projection.ReconciliationAccount = _Data.GLAccount and $projection.ChartOfAccounts = _Data.ChartOfAccounts
{
