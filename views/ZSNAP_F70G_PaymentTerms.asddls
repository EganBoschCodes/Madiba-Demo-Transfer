...
define view entity ZSNAP_F70G_PaymentTerms
	as select distinct from ZSNAP_F70G_PmtTermsCnds as main
	
	association [0..1] to ZSNAP_F70G_PaymentTermsText as _Text on $projection.PaymentTerms = _Text.PaymentTerms
{
